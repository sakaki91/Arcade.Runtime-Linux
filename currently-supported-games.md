...
✅ __DenshaDeGo!!__, Works out of the box!  
...
⚠️ __Wangan Midnight Maximum Tune 3DX+__, It works with additional adjustments, but it's unstable. It was run on an AMD GPU with Intel's FIXGPU to eliminate flickering, and even then it's necessary to include it in LC_ALL=C and variants.    
