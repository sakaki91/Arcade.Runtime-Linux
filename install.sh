...
AWL_NAME="Arcade Wrapper Linux" && AWL_VERSION="3.2-6" && AWL_LOG="/dev/null"
...
dependencyInstall(){
    ...
    if [ -d "$PREFIX"/drive_c ]; then
        ...
        wget -c https://github.com/Open-Wine-Components/umu-proton/releases/download/UMU-Proton-$UMU_VERSION/UMU-Proton-$UMU_VERSION.tar.gz --directory-prefix="$TMP" &>> $AWL_LOG
        ...
        tar -xvf "$TMP"/UMU-Proton-$UMU_VERSION.tar.gz --directory "$TMP" &>> $AWL_LOG
